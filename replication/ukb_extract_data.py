...
>>>>>>> origin/master
    if not data_out.empty:
        ...
        data_out["c002-1.0"] = data_out["30140-1.0"] * data_out["30080-1.0"] / data_out["30120-1.0"]
        data_out["c003-1.0"] = data_out["30140-1.0"] / data_out["30120-1.0"]
        data_out["c004-1.0"] = data_out["30080-1.0"] / data_out["30120-1.0"]
        data_out["c005-1.0"] = data_out["30120-1.0"] / data_out["30190-1.0"]
        if all_data_file.exists():
...
data_unrelated = data_unrelated.dropna(axis="columns", how="all")
...
data_test = data_unrelated.copy().drop(data_train.index)
data_test.to_csv(Path(args.out_dir, "ukb_extracted_data_test.csv"))
